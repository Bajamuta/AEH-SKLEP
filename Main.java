...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Klient klient2 = new Klient("Jan", "Kowalski", sklep);
        
        System.out.println("Admin dodaje towary:");
        ...
        System.out.println("");
        System.out.println("Osoby prawdzaja stan koszyka:");
        admin.sprawdzStanKoszyka(klient.getKoszyk());
        klient.sprawdzStanKoszyka(klient.getKoszyk());
        
        System.out.println("");
        System.out.println("admin zmienia ilość towaru:");
        Towar towar = sklep.getTowar(sklep.wyszukajTowar("woda", null, 0));
        admin.zmienIloscTowaru(towar, 3);
        sklep.pokazTowary();
        
        System.out.println("\nWartosc koszyka i opłacenie:");
        System.out.println("Wartosc: "+klient.sprawdzWartoscKoszyka());
        klient.oplacKoszyk();
        klient.sprawdzStanKoszyka(klient.getKoszyk());
        
        System.out.println("\nWycofanie koszyka, kient nr2:");
        sklep.pokazTowary();
        klient2.dodajDoKoszyka("woda");
        klient2.dodajDoKoszyka("woda");
        klient2.dodajDoKoszyka("dżem");
        klient2.dodajDoKoszyka("dżem");
        klient2.dodajDoKoszyka("chleb");
        klient2.dodajDoKoszyka("marmolada");
        sklep.pokazTowary();
        klient2.pokazKoszyk();
        System.out.println("Wartosc koszyka: "+klient2.sprawdzWartoscKoszyka());
        klient2.usunKoszyka("chleb");
        klient2.pokazKoszyk();
        System.out.println("wartosc koszyka:"+klient2.sprawdzWartoscKoszyka());
        sklep.pokazTowary();
